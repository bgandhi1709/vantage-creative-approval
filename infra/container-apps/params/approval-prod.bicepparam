...
param storageAccountName = readEnvironmentVariable('STORAGE_ACCOUNT_NAME', 'vwapprovalprodsa')
param portalHostname = readEnvironmentVariable('PORTAL_HOSTNAME', 'approvals-prod.example.test')
param campaignSystemBaseUrl = readEnvironmentVariable('CAMPAIGN_SYSTEM_URL', 'https://campaigns-prod.example.test')
